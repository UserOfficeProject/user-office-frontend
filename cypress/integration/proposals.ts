...
context('Proposal tests', () => {
  ...
  describe('Proposal internal  basic tests', () => {
    ...
    it('Internal user should be able to create a proposal', () => {
      cy.login('user');
      cy.visit('/');
    ...
    it('User should not be able to create and submit proposal with inactive internal call', () => {
      createTopicAndQuestionToExistingTemplate();
      cy.login('user');
      cy.visit('/');
      window.localStorage.isInternalUser = true;
    ...
    it('User cannot select inactive intenal call for new proposal', () => {
      let createdCallId: number;
      const createdCallTitle = 'Created call';
