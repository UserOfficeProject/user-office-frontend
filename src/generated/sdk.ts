...
export type GetProposalsCoreQuery = (
  ...
  & { proposalsView: Maybe<(
    { __typename?: 'ProposalsViewQueryResult' }
    & Pick<ProposalsViewQueryResult, 'totalCount'>
    & { proposalViews: Array<(
      { __typename?: 'ProposalView' }
...
export const GetProposalsCoreDocument = gql`
    query getProposalsCore($filter: ProposalsFilter, $first: Int, $offset: Int) {
  proposalsView(filter: $filter, first: $first, offset: $offset) {
    proposalViews {
      primaryKey
      title
      statusId
