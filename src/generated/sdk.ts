...
export type GetUserQuery = { user: { user_title: string, username: string, firstname: string, middlename: string, lastname: string, preferredname: string, gender: string, nationality: number | null, birthdate: any, organisation: number, department: string, position: string, email: string, telephone: string, telephone_alt: string, orcid: string, emailVerified: boolean, placeholder: boolean } | null };

export type GetUserMeQueryVariables = Exact<{ [key: string]: never; }>;


export type GetUserMeQuery = { me: { user_title: string, username: string, firstname: string, middlename: string, lastname: string, preferredname: string, gender: string, nationality: number | null, birthdate: any, organisation: number, department: string, position: string, email: string, telephone: string, telephone_alt: string, orcid: string, emailVerified: boolean, placeholder: boolean } | null };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    createUsersByEmailInvite(variables: CreateUsersByEmailInviteMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<CreateUsersByEmailInviteMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateUsersByEmailInviteMutation>(CreateUsersByEmailInviteDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'createUsersByEmailInvite', 'mutation');
    },
