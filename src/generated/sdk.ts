...
type FieldConfig_DateConfig_Fragment = { small_label: string, required: boolean, tooltip: string, minDate: any | null, maxDate: any | null, defaultDate: any | null, includeTime: boolean };
