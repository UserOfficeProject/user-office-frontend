...
import UserUpcomingExperimentTimesTable from 'components/proposalBooking/UserUpcomingExperimentTimesTable';
...
export default function OverviewPage(props: { userRole: UserRole }) {
  ...
  switch (props.userRole) {
    case UserRole.USER:
      roleBasedOverView = (
        <>
          {isSchedulerEnabled && <UserUpcomingExperimentTimesTable />}
          <PaperContainer>
            <ProposalTableUser />
          </PaperContainer>
        </>
